/// 
/// Example of how to get rid of false sharing using padding
/// !!! Warning !!!
/// Planform dependend
/// Assuming size of int is 4 bytes and cache line is 64 bytes
///  
...
// Padding 64 bytes to eliminate the false sharing
